...
from accounts.views import SendEmailCodeView, VerifyEmailCodeView
...
urlpatterns = [
    ...
    path("auth/email/send-code/", SendEmailCodeView.as_view(), name="send-email-code"),
    path("auth/email/verify/", VerifyEmailCodeView.as_view(), name="verify-email-code"),
]
